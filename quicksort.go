...
func partition(arr []int32, bottom int, top int) int {
	var m int32 = arr[(bottom + top) / 2]
    var l int = bottom-1
    var r int = top+1
...
func qs(arr []int32, bottom int, top int) {
    if bottom < top {
...
func main() {
    ...
    fmt.Println(testing.Benchmark(BenchmarkQuickSort))
}